          ...
          return (
            ...
            >
              ...
              >
                {/* Image Container */}
                <div
                  className={`relative flex size-[54px] sm:size-[60px] md:size-[68px] items-center justify-center overflow-hidden rounded-full shadow-xs transition-shadow duration-300 ${isActive
                    ? "bg-primary-orange shadow-md ring-2 ring-primary-orange/20"
                    : "bg-surface-neutral hover:shadow-md"
                    }`}
                >
                  {cat.icon ? (
                    <Image
              ...
              {/* Label */}
              <span
                className={`max-w-[72px] sm:max-w-[80px] truncate text-center text-[12px] sm:text-[13px] transition-colors duration-200 ${isActive
